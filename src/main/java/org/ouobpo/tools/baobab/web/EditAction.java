...
public class EditAction extends ActionBase {
    ...
    public String update() {
        ...
        // pursues update.
        Book updated = new Book(fId, fTitle, fAuthors, fPublisher, fDate, fPrice, fNote);
    ...
    public String delete() {
        Book deleted = new Book(fId, fTitle, fAuthors, fPublisher, fDate, fPrice, fNote);
